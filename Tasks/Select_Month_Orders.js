...
export default class Select_Month_Orders extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
 ...
 get_Orders(order){
  ...
  axios.post("https://camp-coding.com/classic/Select_Month_Orders.php",data_to_send).then(res=>{
    if(res.status ==200){
...
<FlatList 
        ...
        <View style={[styles.style_view,{alignSelf:'center',}]}>
            ...
            <View style={[styles.style_view,{flexWrap:'wrap',marginBottom:8}]}>
                  {
